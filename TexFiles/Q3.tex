...
\begin{parts}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%	
\part[4]\color{red} If you want to place two figures side by side then use minipage environment. As for example: \color{black} Using nodal analysis, determine the potential across the \qty{4}{\Omega} resistor in Fig.~\ref{fig:ckt-nodal-analysis}
